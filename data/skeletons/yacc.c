...
m4_define([b4_declare_parser_state_variables], [b4_pure_if([[
    ...
    /* The state stack.  */
    yy_small_state_t yyssa[YYINITDEPTH];
    yy_small_state_t *yyss;
    yy_small_state_t *yyssp;
    ...
    yy_small_state_t yyesa@{]b4_percent_define_get([[parse.lac.es-capacity-initial]])[@};
    yy_small_state_t *yyes;
...
typedef ]b4_int_type(0, m4_eval(b4_states_number - 1))[ yy_small_state_t;
...
[# define YYSTACK_BYTES(N) \
     ((N) * (YYSIZEOF (yy_small_state_t) + YYSIZEOF (YYSTYPE) \
             + YYSIZEOF (YYLTYPE)) \
...
`------------------------------------------------------------------*/
                   ...
                   [[yy_small_state_t *yybottom], [yybottom]],
                   [[yy_small_state_t *yytop],    [yytop]])[
{
...
#endif
                      yy_small_state_t **yybottom,
                      yy_small_state_t *yybottom_no_free,
                      yy_small_state_t **yytop, yy_small_state_t *yytop_empty)
{
  ...
  if (*yycapacity < yysize_new)
    {
      ...
      if (YYMAXDEPTH < yyalloc)
        yyalloc = YYMAXDEPTH;
      yybottom_new =
        (yy_small_state_t *) YYSTACK_ALLOC ((YYSIZE_T)
...
static int
yy_lac (yy_small_state_t *yyesa, yy_small_state_t **yyes,
        YYPTRDIFF_T *yyes_capacity, yy_small_state_t *yyssp, int yytoken)
{
  yy_small_state_t *yyes_prev = yyssp;
  yy_small_state_t *yyesp = yyes_prev;
  ...
  while (1)
    {
      ...
      }
      {
        ...
        if (yyesp == yyes_prev)
          {
            yyesp = *yyes;
            *yyesp = (yy_small_state_t) yystate;
          }
        else
          {
...
yysyntax_error (YYPTRDIFF_T *yymsg_alloc, char **yymsg,
                ]b4_lac_if([[yy_small_state_t *yyesa, yy_small_state_t **yyes,
                YYPTRDIFF_T *yyes_capacity, ]])[yy_small_state_t *yyssp, int yytoken)
{
...
yysetstate:
   ...
   *yyssp = (yy_small_state_t) yystate;
